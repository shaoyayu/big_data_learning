...
![图 1. 性能测试结果](images/clip_image001.jpg)
...
![图 2. Importer 类](images/clip_image002.gif)
...
![图 3. 各个 Compiler 类之间的关系](images/clip_image003.jpg)
...
![图 4. XML 编译器框图](images/clip_image004.jpg)
...
![图 5. 语法树](images/clip_image005.jpg)
...
![图 6. Varint 编码](images/clip_image006.jpg)

消息经过序列化后会成为一个二进制数据流，该流中的数据为一系列的 Key-Value 对。如下图所示：

**图** **7. Message Buffer**

![图 7. Message Buffer](images/clip_image007.jpg)
...
![图 8. ZigZag 编码](images/clip_image008.jpg)
...
![图 9. 解包流程图](images/clip_image009.jpg)
